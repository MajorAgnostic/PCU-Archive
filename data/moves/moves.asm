...
; entries correspond to constants/move_constants.asm
	...
	move MEGA_PUNCH,   EFFECT_FLINCH_HIT,        100, NORMAL,        85, 10,  30
	...
	move RAZOR_WIND,   EFFECT_GUST,               80, FLYING,       100, 10,   0
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, NORMAL,       100, 30,   0
	move CUT,          EFFECT_FLINCH_HIT,         70, BUG,           95, 10,  20
	...
	move TAKE_DOWN,    EFFECT_JUMP_KICK,         120, NORMAL,        85, 15,   0
	...
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          18, BUG,           88, 10,   0
	...
	move ROAR,         EFFECT_ATTACK_UP,           0, NORMAL,       100, 10,   0
	move SING,         EFFECT_SLEEP,               0, NORMAL,        70, 10,   0
	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL,        70, 15,   0
	move SONICBOOM,    EFFECT_STATIC_DAMAGE,      25, NORMAL,        90, 20,   0
	move DISABLE,      EFFECT_DISABLE,             0, NORMAL,        80, 10,   0
	move ACID,         EFFECT_BURN_HIT,           50, POISON,       100, 10,  20
	...
	move STRENGTH,     EFFECT_NORMAL_HIT,         95, NORMAL,       100, 15,   0
	...
	move POISONPOWDER, EFFECT_POISON,              0, POISON,       100, 15,   0
	...
	move FIRE_SPIN,    EFFECT_BURN,                0, FIRE,          75, 15,   0
	...
	move SKULL_BASH,   EFFECT_SKULL_BASH,        150, STEEL,         90,  5,   0
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          20, STEEL,        100, 10,   0
	...
	move GLARE,        EFFECT_PARALYZE,            0, NORMAL,       100, 15,   0
	move DREAM_EATER,  EFFECT_DREAM_EATER,       100, PSYCHIC_TYPE, 100, 15,   0
	move POISON_GAS,   EFFECT_TOXIC,               0, POISON,        95,  5,   0
	...
	move SKY_ATTACK,   EFFECT_SKY_ATTACK,        140, FLYING,        90,  5,  30
	...
	move CRABHAMMER,   EFFECT_NORMAL_HIT,        120, WATER,         85, 10,   0
	...
	move TRIPLE_KICK,  EFFECT_TRIPLE_KICK,        20, FIGHTING,      95, 10,   0
	...
	move FLAME_WHEEL,  EFFECT_FLAME_WHEEL,        60, FIRE,         100, 15,  20
	...
	move POWDER_SNOW,  EFFECT_FREEZE_HIT,         40, ICE,          100, 10,  30
	...
	move FURY_CUTTER,  EFFECT_FURY_CUTTER,        20, BUG,           90, 15,   0
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     80, STEEL,        100, 15,  10
	...
	move PRESENT,      EFFECT_PRESENT,             1, NORMAL,       100, 10,   0
	...
	move DRAGONBREATH, EFFECT_PARALYZE_HIT,       80, DRAGON,       100, 15,  30
	...
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,         90, 10,  30
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      70, STEEL,         90, 15,  30
	...
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,      100, PSYCHIC_TYPE, 100, 10,   0
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   20, FIGHTING,     100, 10, 100
	move WHIRLPOOL,    EFFECT_PRIORITY_HIT,       60, WATER,        100, 10,   0
	move BEAT_UP,      EFFECT_MULTI_HIT,          25, DARK,          90, 10,   0
