...
Rival1Group:
	...
	db 34, QUILAVA
			...
			dw $000C, $000C, $000C, $000C, $000C
			db CHARCOAL
			db FLAMETHROWER, SUBMISSION, SUNNY_DAY, HIDDEN_POWER
	db -1 ; end
...
ChampionGroup:
	...
	db 69, DRAGONITE
			...
			dw $0159, $0159, $0159, $0159, $0159
			db FOCUS_BAND
			db DYNAMICPUNCH, ICE_BEAM, DRAGON_RAGE, THUNDER
	db 69, CHARIZARD
...
ScientistGroup:
	...
	; SCIENTIST (8) - Added to Seafoam Gym
	...
	; SCIENTIST (9) - Added to Seafoam Gym
	...
	; SCIENTIST (10) - Added to Seafoam Gym
	...
	; SCIENTIST (11) - Added to Seafoam Gym
	...
	; SCIENTIST (12) - Added to Seafoam Gym
...
ErikaGroup:
	...
	db 75, BELLOSSOM
			...
			dw $0173, $0173, $0173, $0173, $0173
			db SCOPE_LENS
			db ANCIENTPOWER, RAZOR_LEAF, FIRE_SPIN, PAIN_SPLIT
	db -1 ; end
...
Morty2Group:
	...
	db 82, CLOYSTER
			...
			dw $018D, $018D, $018D, $018D, $018D
			db MYSTIC_WATER
			db WHIRLPOOL, ICE_BEAM, SPIKES, RAIN_DANCE
	db 81, SMEARGLE
			db $bf, PERFECT_DV ; atk|def, spd|spc
			dw $018D, $018D, $018D, $018D, $018D
			db FOCUS_BAND
