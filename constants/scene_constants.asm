...
; wRoute42GateSceneID
	const_def
	const SCENE_ROUTE42ECRUTEAKGATE_NOTHING 
	const SCENE_ROUTE42ECRUTEAKGATE_SCENE
	
; wSilverCaveRoom2SceneID
	const_def
	const SCENE_SILVERCAVEROOM2_NOTHING 
	const SCENE_SILVERCAVEROOM2_SCENE
