CELADONGAMECORNERPRIZEROOM_TM32_COINS EQU 6000
CELADONGAMECORNERPRIZEROOM_TM29_COINS EQU 6000
CELADONGAMECORNERPRIZEROOM_TM15_COINS EQU 9500
CELADONGAMECORNERPRIZEROOM_PIKACHU_COINS  EQU 1111
CELADONGAMECORNERPRIZEROOM_PORYGON_COINS  EQU 3333
CELADONGAMECORNERPRIZEROOM_STARTER_COINS  EQU 5555
...
.DoubleTeam:
	...
	getitemname STRING_BUFFER_3, BRIGHTPOWDER
...
.Porygon:
	...
	setval PORYGON
	special GameCornerPrizeMonCheckDex
	givepoke PORYGON, 10, POLKADOT_BOW
	takecoins CELADONGAMECORNERPRIZEROOM_PORYGON_COINS
	sjump .loop

.Starter:
	checkcoins CELADONGAMECORNERPRIZEROOM_STARTER_COINS
	ifequal HAVE_LESS, CeladonPrizeRoom_notenoughcoins
	readvar VAR_PARTYCOUNT
	ifequal PARTY_LENGTH, CeladonPrizeRoom_notenoughroom
	readvar VAR_WEEKDAY
	ifequal TUESDAY, .Charmander
	ifequal WEDNESDAY, .Squirtle
	ifequal THURSDAY, .Chikorita
	ifequal FRIDAY, .Cyndaquil
	ifequal SATURDAY, .Totodile
	...
	setval BULBASAUR
	special GameCornerPrizeMonCheckDex
	givepoke BULBASAUR, 5, NORMAL_BOX
	takecoins CELADONGAMECORNERPRIZEROOM_STARTER_COINS
	sjump .loop
...
.Charmander:
	...
	setval CHARMANDER
	special GameCornerPrizeMonCheckDex
	givepoke CHARMANDER, 5, NORMAL_BOX
	takecoins CELADONGAMECORNERPRIZEROOM_STARTER_COINS
	sjump .loop
...
.Squirtle:
	...
	setval SQUIRTLE
	special GameCornerPrizeMonCheckDex
	givepoke SQUIRTLE, 5, NORMAL_BOX
	takecoins CELADONGAMECORNERPRIZEROOM_STARTER_COINS
	sjump .loop
...
.Chikorita:
	...
	setval CHIKORITA
	special GameCornerPrizeMonCheckDex
	givepoke CHIKORITA, 5, NORMAL_BOX
	takecoins CELADONGAMECORNERPRIZEROOM_STARTER_COINS
	sjump .loop
...
.Cyndaquil:
	...
	setval CYNDAQUIL
	special GameCornerPrizeMonCheckDex
	givepoke CYNDAQUIL, 5, NORMAL_BOX
	takecoins CELADONGAMECORNERPRIZEROOM_STARTER_COINS
	sjump .loop
...
.Totodile:
	...
	setval TOTODILE
	special GameCornerPrizeMonCheckDex
	givepoke TOTODILE, 5, NORMAL_BOX
	takecoins CELADONGAMECORNERPRIZEROOM_STARTER_COINS
	sjump .loop
