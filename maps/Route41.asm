...
Route41_MapEvents:
	...
	bg_event 28, 32, BGEVENT_ITEM, Route41HiddenWaterStone
	...
	object_event 25, 35, SPRITE_SWIMMER_GIRL, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 3, TrainerSwimmerfDenise, -1
