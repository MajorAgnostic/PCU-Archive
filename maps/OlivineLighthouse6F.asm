	...
	const OLIVINELIGHTHOUSE6F_AMPHY
...
OlivineLighthouse6F_MapEvents:
	...
	object_event  9,  8, SPRITE_AMPHAROS, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, OlivineLighthouseAmphy, -1
